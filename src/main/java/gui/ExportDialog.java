    ...
    private void bntExportarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bntExportarActionPerformed
        ...
        try {
            if (id.isEmpty()) {
                ...
                fileChooser.setFileFilter(csvFilter); // Define o filtro CSV como o padrão
                ...
                // **Melhoria aqui: Garantir a extensão .csv**
                if (!path.toLowerCase().endsWith(".csv")) {
                    path += ".csv"; // Adiciona a extensão se não estiver presente
                }
