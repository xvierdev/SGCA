...
public class EditAlunoDialog extends javax.swing.JDialog {
    ...
    public EditAlunoDialog(JFrame owner, AlunoService alunoService, CursoService cursoService, Aluno aluno) {
        ...
        txtDataNasc
                .setText(aluno.getDataNascimento().format(java.time.format.DateTimeFormatter.ofPattern("dd/MM/yyyy")));
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout
                                                ...
                                                .addGroup(layout
                                                        ...
                                                        .addComponent(txtCpf, javax.swing.GroupLayout.DEFAULT_SIZE, 320,
                                                                Short.MAX_VALUE)
    ...
    private void btnConfirmeActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnConfirmeActionPerformed
        try {
            ...
            alunoService.atualizarAluno(aluno.getIdAluno(), idCurso, nome, cpf, telefone, email,
                    LocalDate.parse(dataNascimento, java.time.format.DateTimeFormatter.ofPattern("dd/MM/yyyy")),
